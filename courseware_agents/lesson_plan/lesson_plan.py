...
Dependencies:
    ...
    - Custom Utilities:
         • process_logo_image from generate_ap_fg_lg/utils/helper – For processing and embedding the organization's logo.
...
LP_TEMPLATE_DIR = "courseware_agents/lesson_plan/templates/LP_TGS-Ref-No_Course-Title_v1.docx"
